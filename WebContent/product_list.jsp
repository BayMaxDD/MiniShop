...
<body>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage != 1 }">
				<li>
					<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByCid&cid=${cid }&currentPage=${pageBean.currentPage-1 }">
			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
				...
				<c:if test="${pageBean.currentPage != page }">
					<li>
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByCid&cid=${cid }&currentPage=${page }">
						${page }</a>
					</li>
				</c:if>
			</c:forEach>
			...
			<c:if test="${pageBean.currentPage != pageBean.totalPage }">
				<li><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByCid&cid=${cid }&currentPage=${pageBean.currentPage+1 }" 
					   aria-label="Next"> 
						<span aria-hidden="true">&raquo;
						</span>
					</a>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				<c:forEach items="${Histroylist }" var="historyPro">
