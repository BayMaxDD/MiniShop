	...
	<head>
		...
		<script type="text/javascript">
			function delProFromCart(pid){
				if(confirm("您是否删除该商品项")){
					location.href="${pageContext.request.contextPath }/CartServlet?method=delProFromCart&pid="+pid;
				}
			}
			function clearChart(){
				if(confirm("您是否清除购物车,请深思")){
					location.href="${pageContext.request.contextPath }/CartServlet?method=clearChart";
				}
			}
		</script>
	</head>
			...
			<div class="container">
					...
					<div style="margin:0 auto; margin-top:10px;width:950px;">
						...
						<table class="table table-bordered">
							<tbody>
								...
								<c:forEach items="${cart.cart }" var="entry">
									<tr class="active">
				...
				<div style="margin-right:130px;">
					...
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<a href="javascript:;" onclick="clearChart()" id="clear" class="clear">清空购物车</a>
						<a href="${pageContext.request.contextPath }/CartServlet?method=orderSubmit">
		...
		<c:if test="${empty cart.cart }">
			<div style ="margin-left:6%;">
				<a href="${pageContext.request.contextPath }">
					<img alt="" src="${pageContext.request.contextPath }/images/Mi_cart.jpg">
				</a>
			</div>
		</c:if>
